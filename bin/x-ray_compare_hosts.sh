...
function compareHosts() {
    ...
    if [ ! -d $left_base_dir/$left_host/$left_snapshot/$left_domain/runtime/servers/$left_instance ]; then
        echo Error: Left instance selected to compare does not exist on server snapshot.
        return 1
    fi

    if [ ! -d $right_base_dir/$right_host/$right_snapshot/$right_domain/runtime/servers/$right_instance ]; then
...
EOF
    ...
    rm -rf $left_base_dir/$left_host/$left_snapshot/$left_domain/runtime/servers/wls_instance
    mkdir $left_base_dir/$left_host/$left_snapshot/$left_domain/runtime/servers/wls_instance
    cp -R $left_base_dir/$left_host/$left_snapshot/$left_domain/runtime/servers/$left_instance/* $left_base_dir/$left_host/$left_snapshot/$left_domain/runtime/servers/wls_instance
    find $left_base_dir/$left_host/$left_snapshot/$left_domain/runtime/servers/wls_instance -type f -exec sed -i "s/$left_instance/\$[WLS_INSTANCE]/g" {} \;
    ...
    rm -rf $right_base_dir/$right_host/$right_snapshot/$right_domain/servers/wls_instance 
    mkdir $right_base_dir/$right_host/$right_snapshot/$right_domain/servers/wls_instance
    cp -R $right_base_dir/$right_host/$right_snapshot/$right_domain/servers/$right_instance/* $right_base_dir/$right_host/$right_snapshot/$right_domain/servers/wls_instance 
    find $right_base_dir/$right_host/$right_snapshot/$right_domain/servers/wls_instance -type f -exec sed -i "s/$right_instance/\$[WLS_INSTANCE]/g" {} \;
    
    rm -rf $right_base_dir/$right_host/$right_snapshot/$right_domain/runtime/servers/wls_instance
    mkdir $right_base_dir/$right_host/$right_snapshot/$right_domain/runtime/servers/wls_instance 
    cp -R $right_base_dir/$right_host/$right_snapshot/$right_domain/runtime/servers/$right_instance/* $right_base_dir/$right_host/$right_snapshot/$right_domain/runtime/servers/wls_instance 
    find $right_base_dir/$right_host/$right_snapshot/$right_domain/runtime/servers/wls_instance -type f -exec sed -i "s/$right_instance/\$[WLS_INSTANCE]/g" {} \;
 
    # set domain dirs
    left_domain_home=$left_base_dir/$left_host/$left_snapshot/$left_domain
    right_domain_home=$right_base_dir/$right_host/$right_snapshot/$right_domain
...
function prepare_html_report() {
    ...
    cat $left_base_dir/$left_host/$left_snapshot/wls/variables | sed 's|$|</br>|g' >>$report_root/diff_report.html
    ...
    chmod -R o+x $report_root
    chmod -R o+r $report_root
    cd
}
...
batch)
    ...
    ;;
*)
    left_base_dir=$1; shift
    left_host=$1; shift
    left_domain=$1; shift
    left_instance=$1; shift
    left_snapshot=$1; shift

    right_base_dir=$1; shift
    right_host=$1; shift
    right_domain=$1; shift
    right_instance=$1; shift
    right_snapshot=$1; shift
    ...
    # verify parameters
    #
    echo "Left: $left_base_dir/$left_host/$left_snapshot/$left_domain/runtime/servers/$left_instance "
    if [ ! -d $left_base_dir/$left_host/$left_snapshot/$left_domain/runtime/servers/$left_instance ]; then
    ...
    echo "Right: $right_base_dir/$right_host/$right_snapshot/$right_domain/runtime/servers/$right_instance"
    if [ ! -d $right_base_dir/$right_host/$right_snapshot/$right_domain/runtime/servers/$right_instance ]; then
