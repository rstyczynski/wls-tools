...
cat $base_dir/$left/$snapshot/wls/variables | sed 's|$|</br>|g' >>$report_root/diff_report.html

echo "<h2>$left</h2>"  >>$report_root/diff_report.html
echo "<h3>domain</h3>"  >>$report_root/diff_report.html
cat $base_dir/$left/$snapshot/wls/$left_domain_name/variables | sed 's|$|</br>|g' >>$report_root/diff_report.html
for wls_name in $(ls $base_dir/$left/$snapshot/wls/$left_domain_name/servers); do
   echo "<h3>$wls_name</h3>"  >>$report_root/diff_report.html
   cat $base_dir/$left/$snapshot/wls/$left_domain_name/servers/$wls_name/variables >>$report_root/diff_report.html
done

echo "<h2>$right</h2>"  >>$report_root/diff_report.html
echo "<h3>domain</h3>"  >>$report_root/diff_report.html
cat $base_dir/$right/$snapshot/wls/$right_domain_name/variables | sed 's|$|</br>|g' >>$report_root/diff_report.html
for wls_name in $(ls $base_dir/$right/$snapshot/wls/$right_domain_name/servers); do
   echo "<h3>$wls_name</h3>"  >>$report_root/diff_report.html
   cat $base_dir/$right/$snapshot/wls/$right_domain_name/servers/$wls_name/variables >>$report_root/diff_report.html
done
